...
class HataSayfalar extends StatefulWidget {
  const HataSayfalar({Key? key}) : super(key: key);

  @override
  _HataSayfalarState createState() => _HataSayfalarState();
}

class _HataSayfalarState extends State<HataSayfalar> {
  @override
